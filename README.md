...
This is a sample template for SecuringAPIs - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name securingapis --tail
```
...
```bash
aws cloudformation delete-stack --stack-name securingapis
```
